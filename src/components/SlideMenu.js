...
const SlideMenu = ({ ...props
	...
	const goTo = url => {
		...
		}, 200); // Laisse le menu se fermer avant la navigation
	};
	...
	return <>
		...
		{!open && <div onClick={() => setOpen(true)} style={{
			position: "fixed",
			top: "20px",
			left: "20px",
			zIndex: "1003",
